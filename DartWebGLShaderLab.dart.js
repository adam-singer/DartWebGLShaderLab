...
$defProp(Object.prototype, "is$html_ImageData", function() {
  return false;
});
$defProp(Object.prototype, "is$html_WebGLRenderingContext", function() {
  return false;
});
$defProp(Object.prototype, "texImage2D$6", function($0, $1, $2, $3, $4, $5) {
  return this.noSuchMethod("texImage2D", [$0, $1, $2, $3, $4, $5]);
});
$defProp(Object.prototype, "viewport$4", function($0, $1, $2, $3) {
...
$dynamic("get$byteLength").ArrayBuffer = function() { return this.byteLength; };
// ********** Code for _ArrayBufferViewJs **************
$dynamic("get$byteLength").ArrayBufferView = function() { return this.byteLength; };
// ********** Code for _NodeJs **************
...
$dynamic("texImage2D$6").WebGLRenderingContext = function($0, $1, $2, $3, $4, $5) {
  return this.texImage2D($0, $1, $2, $3, $4, $5);
};
...
_TypedArrayFactoryProvider.Uint8Array$fromList$factory = function(list) {
  return _TypedArrayFactoryProvider._U8(_TypedArrayFactoryProvider.ensureNative(list));
}
_TypedArrayFactoryProvider._F32 = function(arg) {
  return new Float32Array(arg);
}
_TypedArrayFactoryProvider._U8 = function(arg) {
...
ArrayBufferViewWrappingImplementation.prototype.get$byteLength = function() {
  return this._ptr.get$byteLength();
}
...
WebGLRenderingContextWrappingImplementation.prototype.activeTexture = function(texture) {
  this._ptr.activeTexture(texture);
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.bindFramebuffer = function(target, framebuffer) {
  this._ptr.bindFramebuffer(target, LevelDom.unwrap(framebuffer));
  return;
}
WebGLRenderingContextWrappingImplementation.prototype.bindTexture = function(target, texture) {
  this._ptr.bindTexture(target, LevelDom.unwrap(texture));
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.bufferSubData = function(target, offset, data) {
  if (!!(data && data.is$html_ArrayBuffer())) {
    this._ptr.bufferSubData(target, offset, LevelDom.unwrapMaybePrimitive(data));
    return;
  }
  else {
    if (!!(data && data.is$html_ArrayBufferView())) {
      this._ptr.bufferSubData(target, offset, LevelDom.unwrapMaybePrimitive(data));
      return;
    }
  }
...
WebGLRenderingContextWrappingImplementation.prototype.createBuffer = function() {
  return LevelDom.wrapWebGLBuffer(this._ptr.createBuffer$0());
}
WebGLRenderingContextWrappingImplementation.prototype.createFramebuffer = function() {
  return LevelDom.wrapWebGLFramebuffer(this._ptr.createFramebuffer());
}
...
WebGLRenderingContextWrappingImplementation.prototype.createTexture = function() {
  return LevelDom.wrapWebGLTexture(this._ptr.createTexture());
}
...
WebGLRenderingContextWrappingImplementation.prototype.flush = function() {
  this._ptr.flush();
  return;
}
WebGLRenderingContextWrappingImplementation.prototype.framebufferTexture2D = function(target, attachment, textarget, texture, level) {
  this._ptr.framebufferTexture2D(target, attachment, textarget, LevelDom.unwrap(texture), level);
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.pixelStorei = function(pname, param) {
  this._ptr.pixelStorei(pname, param);
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.texImage2D = function(target, level, internalformat, format_OR_width, height_OR_type, border_OR_canvas_OR_image_OR_pixels, format, type, pixels) {
  if (!!(border_OR_canvas_OR_image_OR_pixels && border_OR_canvas_OR_image_OR_pixels.is$html_ImageData())) {
    if (null == format) {
      if (null == type) {
        if (null == pixels) {
          this._ptr.texImage2D$6(target, level, internalformat, format_OR_width, height_OR_type, LevelDom.unwrapMaybePrimitive(border_OR_canvas_OR_image_OR_pixels));
          return;
        }
      }
    }
    ...
    if (!!(border_OR_canvas_OR_image_OR_pixels && border_OR_canvas_OR_image_OR_pixels.is$ImageElement())) {
      if (null == format) {
        if (null == type) {
          if (null == pixels) {
            this._ptr.texImage2D$6(target, level, internalformat, format_OR_width, height_OR_type, LevelDom.unwrapMaybePrimitive(border_OR_canvas_OR_image_OR_pixels));
      ...
      if (!!(border_OR_canvas_OR_image_OR_pixels && border_OR_canvas_OR_image_OR_pixels.is$CanvasElement())) {
        if (null == format) {
          if (null == type) {
            if (null == pixels) {
              this._ptr.texImage2D$6(target, level, internalformat, format_OR_width, height_OR_type, LevelDom.unwrapMaybePrimitive(border_OR_canvas_OR_image_OR_pixels));
        ...
        if ((typeof(border_OR_canvas_OR_image_OR_pixels) == 'number')) {
          this._ptr.texImage2D(target, level, internalformat, format_OR_width, height_OR_type, LevelDom.unwrapMaybePrimitive(border_OR_canvas_OR_image_OR_pixels), format, type, LevelDom.unwrap(pixels));
          return;
        }
      }
    }
...
WebGLRenderingContextWrappingImplementation.prototype.texParameteri = function(target, pname, param) {
  this._ptr.texParameteri(target, pname, param);
  return;
}
WebGLRenderingContextWrappingImplementation.prototype.uniform1f = function(location, x) {
  this._ptr.uniform1f(LevelDom.unwrap(location), x);
  return;
}
WebGLRenderingContextWrappingImplementation.prototype.uniform1i = function(location, x) {
  this._ptr.uniform1i(LevelDom.unwrap(location), x);
  return;
}
...
WebGLRenderingContextWrappingImplementation.prototype.texImage2D$6 = WebGLRenderingContextWrappingImplementation.prototype.texImage2D;
...
LevelDom.wrapUint8Array = function(raw) {
  return null == raw ? null : null != raw.get$dartObjectLocalStorage() ? raw.get$dartObjectLocalStorage() : new Uint8ArrayWrappingImplementation._wrap$ctor(raw);
}
...
LevelDom.wrapWebGLFramebuffer = function(raw) {
  return null == raw ? null : null != raw.get$dartObjectLocalStorage() ? raw.get$dartObjectLocalStorage() : new WebGLFramebufferWrappingImplementation._wrap$ctor(raw);
}
...
LevelDom.wrapWebGLTexture = function(raw) {
  return null == raw ? null : null != raw.get$dartObjectLocalStorage() ? raw.get$dartObjectLocalStorage() : new WebGLTextureWrappingImplementation._wrap$ctor(raw);
}
...
Uint8ArrayWrappingImplementation.prototype.is$html_ArrayBufferView = function(){return true};
Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory = function(list) {
  return LevelDom.wrapUint8Array(_TypedArrayFactoryProvider.Uint8Array$fromList$factory(list));
}
...
//  ********** Library DartWebGLShaderLab **************
// ********** Code for DartWebGLShaderLab **************
function DartWebGLShaderLab() {
  this.halted = false;
  this.delay = (3);
  this.it = (1);
  this.frames = (0);
...
DartWebGLShaderLab.prototype.getShader = function(g, id) {
  return createShaderFromScriptElement(g, id);
}
DartWebGLShaderLab.prototype.run = function() {
  var $this = this; // closure support
  var $0, $1;
  this.c = html_get$document().query("#c");
  this.gl = getWebGLContext(this.c);
  if (!(($0 = this.c) && $0.is$CanvasElement()) || !(($1 = this.gl) && $1.is$html_WebGLRenderingContext())) {
    dart_core_print("failed to load canvas");
    return;
  }
  html_get$document().get$on().get$mouseMove().add((function (event) {
    $this.mouseX = $div(event.get$pageX(), $this.viewX);
    $this.mouseY = (1) - $div(event.get$pageY(), $this.viewY);
  })
  , false);
  html_get$document().get$on().get$click().add((function (_) {
    $this.halted = !$this.halted;
  })
  , false);
  this.c.set$width(this.viewX);
  this.c.set$height(this.viewY);
  this.prog_advance = this.gl.createProgram();
  this.gl.attachShader(this.prog_advance, this.getShader(this.gl, "#shader-vs"));
  this.gl.attachShader(this.prog_advance, this.getShader(this.gl, "#shader-fs-advance"));
  this.gl.linkProgram(this.prog_advance);
  this.prog_composite = this.gl.createProgram();
  this.gl.attachShader(this.prog_composite, this.getShader(this.gl, "#shader-vs"));
  this.gl.attachShader(this.prog_composite, this.getShader(this.gl, "#shader-fs-composite"));
  this.gl.linkProgram(this.prog_composite);
  this.prog_blur_horizontal = this.gl.createProgram();
  this.gl.attachShader(this.prog_blur_horizontal, this.getShader(this.gl, "#shader-vs"));
  this.gl.attachShader(this.prog_blur_horizontal, this.getShader(this.gl, "#shader-fs-blur-horizontal"));
  this.gl.linkProgram(this.prog_blur_horizontal);
  this.prog_blur_vertical = this.gl.createProgram();
  this.gl.attachShader(this.prog_blur_vertical, this.getShader(this.gl, "#shader-vs"));
  this.gl.attachShader(this.prog_blur_vertical, this.getShader(this.gl, "#shader-fs-blur-vertical"));
  this.gl.linkProgram(this.prog_blur_vertical);
  var posBuffer = this.gl.createBuffer$0();
  this.gl.bindBuffer((34962), posBuffer);
  var vertices = Float32ArrayWrappingImplementation.Float32ArrayWrappingImplementation$from$factory([(-1), (-1), (0), (1), (-1), (0), (-1), (1), (0), (1), (1), (0)]);
  var aPosLoc = this.gl.getAttribLocation(this.prog_advance, "aPos");
  this.gl.enableVertexAttribArray(aPosLoc);
  var aTexLoc = this.gl.getAttribLocation(this.prog_advance, "aTexCoord");
  this.gl.enableVertexAttribArray(aTexLoc);
  var texCoords = Float32ArrayWrappingImplementation.Float32ArrayWrappingImplementation$from$factory([(0), (0), (1), (0), (0), (1), (1), (1)]);
  var texCoordOffset = vertices.get$byteLength();
  this.gl.bufferData((34962), $add(texCoordOffset, texCoords.get$byteLength()), (35044));
  this.gl.bufferSubData((34962), (0), vertices);
  this.gl.bufferSubData((34962), texCoordOffset, texCoords);
  this.gl.vertexAttribPointer(aPosLoc, (3), (5126), false, (0), (0));
  this.gl.vertexAttribPointer(aTexLoc, (2), (5126), false, (0), texCoordOffset);
  var noisepixels = [];
  var pixels = [];
  for (var i = (0);
   $lt(i, this.sizeX); i = $add(i, (1))) {
    for (var j = (0);
     $lt(j, this.sizeY); j = $add(j, (1))) {
      noisepixels.add$1(Math.random() * (255));
      noisepixels.add$1(Math.random() * (255));
      noisepixels.add$1(Math.random() * (255));
      noisepixels.add$1((255));
      pixels.add$1((0));
      pixels.add$1((0));
      pixels.add$1((0));
      pixels.add$1((255));
  ...
  var rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(noisepixels);
  this.texture_main_l = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_main_l);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9729));
  this.gl.texParameteri((3553), (10240), (9729));
  this.texture_main_n = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_main_n);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9728));
  this.gl.texParameteri((3553), (10240), (9728));
  rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(noisepixels);
  rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(noisepixels);
  this.texture_main2_l = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_main2_l);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9729));
  this.gl.texParameteri((3553), (10240), (9729));
  this.texture_main2_n = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_main2_n);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9728));
  this.gl.texParameteri((3553), (10240), (9728));
  rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(pixels);
  this.texture_helper = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_helper);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9729));
  this.gl.texParameteri((3553), (10240), (9729));
  rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(pixels);
  this.texture_blur = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_blur);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9729));
  this.gl.texParameteri((3553), (10240), (9729));
  rawData = Uint8ArrayWrappingImplementation.Uint8ArrayWrappingImplementation$from$factory(noisepixels);
  this.texture_noise_l = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_noise_l);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9729));
  this.gl.texParameteri((3553), (10240), (9729));
  this.texture_noise_n = this.gl.createTexture();
  this.gl.bindTexture((3553), this.texture_noise_n);
  this.gl.pixelStorei((3317), (1));
  this.gl.texImage2D((3553), (0), (6408), this.sizeX, this.sizeY, (0), (6408), (5121), rawData);
  this.gl.texParameteri((3553), (10241), (9728));
  this.gl.texParameteri((3553), (10240), (9728));
  this.FBO_main = this.gl.createFramebuffer();
  this.gl.bindFramebuffer((36160), this.FBO_main);
  this.gl.framebufferTexture2D((36160), (36064), (3553), this.texture_main_l, (0));
  this.FBO_main2 = this.gl.createFramebuffer();
  this.gl.bindFramebuffer((36160), this.FBO_main2);
  this.gl.framebufferTexture2D((36160), (36064), (3553), this.texture_main2_l, (0));
  this.FBO_helper = this.gl.createFramebuffer();
  this.gl.bindFramebuffer((36160), this.FBO_helper);
  this.gl.framebufferTexture2D((36160), (36064), (3553), this.texture_helper, (0));
  this.FBO_blur = this.gl.createFramebuffer();
  this.gl.bindFramebuffer((36160), this.FBO_blur);
  this.gl.framebufferTexture2D((36160), (36064), (3553), this.texture_blur, (0));
  this.FBO_noise = this.gl.createFramebuffer();
  this.gl.bindFramebuffer((36160), this.FBO_noise);
  this.gl.framebufferTexture2D((36160), (36064), (3553), this.texture_noise_l, (0));
  this.gl.useProgram(this.prog_advance);
  this.setUniforms(this.prog_advance);
  this.gl.useProgram(this.prog_blur_horizontal);
  this.gl.uniform2f(this.gl.getUniformLocation(this.prog_blur_horizontal, "pixelSize"), $div((1.0), this.sizeX), $div((1.0), this.sizeY));
  this.gl.uniform1i(this.gl.getUniformLocation(this.prog_blur_horizontal, "src_tex"), (0));
  this.gl.useProgram(this.prog_blur_vertical);
  this.gl.uniform2f(this.gl.getUniformLocation(this.prog_blur_vertical, "pixelSize"), $div((1.0), this.sizeX), $div((1.0), this.sizeY));
  this.gl.uniform1i(this.gl.getUniformLocation(this.prog_blur_vertical, "src_tex"), (0));
  this.gl.useProgram(this.prog_composite);
...
DartWebGLShaderLab.prototype.setUniforms = function(program) {
  this.gl.uniform2f(this.gl.getUniformLocation(program, "pixelSize"), $div((1.0), this.sizeX), $div((1.0), this.sizeY));
  this.gl.uniform4f(this.gl.getUniformLocation(program, "rnd"), Math.random(), Math.random(), Math.random(), Math.random());
  this.gl.uniform1f(this.gl.getUniformLocation(program, "fps"), this.fps);
  this.gl.uniform1f(this.gl.getUniformLocation(program, "time"), this.time);
  this.gl.uniform2f(this.gl.getUniformLocation(program, "aspect"), Math.max((1), $div(this.viewX, this.viewY)), Math.max((1), $div(this.viewY, this.viewX)));
  this.gl.uniform2f(this.gl.getUniformLocation(program, "mouse"), this.mouseX, this.mouseY);
  this.gl.uniform1i(this.gl.getUniformLocation(program, "sampler_prev"), (0));
  this.gl.uniform1i(this.gl.getUniformLocation(program, "sampler_prev_n"), (1));
  this.gl.uniform1i(this.gl.getUniformLocation(program, "sampler_blur"), (2));
  this.gl.uniform1i(this.gl.getUniformLocation(program, "sampler_noise"), (3));
  this.gl.uniform1i(this.gl.getUniformLocation(program, "sampler_noise_n"), (4));
}
DartWebGLShaderLab.prototype.calculateBlurTexture = function() {
...
DartWebGLShaderLab.prototype.advance = function() {
  this.gl.viewport$4((0), (0), this.sizeX, this.sizeY);
  this.gl.useProgram(this.prog_advance);
  this.setUniforms(this.prog_advance);
  if ($gt(this.it, (0))) {
  ...
  this.gl.flush();
  this.calculateBlurTexture();
  this.it = $negate(this.it);
}
DartWebGLShaderLab.prototype.composite = function() {
...
DartWebGLShaderLab.prototype.anim = function(i) {
  html_get$document().get$window().webkitRequestAnimationFrame(this.get$anim(), this.c);
  if (!this.halted) {
    this.advance();
  }
  this.composite();
  if (this.watch.elapsedInMs() >= (1000)) {
    this.fps = ((1000) * (this.frames.toDouble() / this.watch.elapsedInMs().toDouble())).round();
    dart_core_print(("fps=" + this.fps));
    html_get$document().query("#fps").set$innerHTML(("fps=" + this.fps));
    this.frames = (0);
    this.watch.reset();
  }
}
DartWebGLShaderLab.prototype.get$anim = function() {
  return this.anim.bind(this);
}
// ********** Code for top level **************
function main() {
...
(function(){
  var v0/*Uint8Array*/ = 'Uint8Array|Uint8ClampedArray';
  ...
  var v7/*Element*/ = [v2/*HTMLElement*/,v3/*SVGComponentTransferFunctionElement*/,'Element|SVGElement|SVGAElement|SVGAltGlyphDefElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGCircleElement|SVGClipPathElement|SVGCursorElement|SVGDefsElement|SVGDescElement|SVGEllipseElement|SVGFEBlendElement|SVGFEColorMatrixElement|SVGFEComponentTransferElement|SVGFECompositeElement|SVGFEConvolveMatrixElement|SVGFEDiffuseLightingElement|SVGFEDisplacementMapElement|SVGFEDistantLightElement|SVGFEDropShadowElement|SVGFEFloodElement|SVGFEGaussianBlurElement|SVGFEImageElement|SVGFEMergeElement|SVGFEMergeNodeElement|SVGFEMorphologyElement|SVGFEOffsetElement|SVGFEPointLightElement|SVGFESpecularLightingElement|SVGFESpotLightElement|SVGFETileElement|SVGFETurbulenceElement|SVGFilterElement|SVGFontElement|SVGFontFaceElement|SVGFontFaceFormatElement|SVGFontFaceNameElement|SVGFontFaceSrcElement|SVGFontFaceUriElement|SVGForeignObjectElement|SVGGElement|SVGGlyphElement|SVGGlyphRefElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGHKernElement|SVGImageElement|SVGLineElement|SVGMPathElement|SVGMarkerElement|SVGMaskElement|SVGMetadataElement|SVGMissingGlyphElement|SVGPathElement|SVGPatternElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGSVGElement|SVGScriptElement|SVGStopElement|SVGStyleElement|SVGSwitchElement|SVGSymbolElement|SVGTextContentElement|SVGTextPathElement|SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTitleElement|SVGUseElement|SVGVKernElement|SVGViewElement'].join('|');
  var v8/*AbstractWorker*/ = 'AbstractWorker|SharedWorker|Worker';
  var v9/*Node*/ = [v5/*CharacterData*/,v6/*Document*/,v7/*Element*/,'Node|Attr|DocumentFragment|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction|ShadowRoot'].join('|');
  var v10/*ArrayBufferView*/ = [v0/*Uint8Array*/,'ArrayBufferView|DataView|Float32Array|Float64Array|Int16Array|Int32Array|Int8Array|Uint16Array|Uint32Array'].join('|');
  var v11/*Blob*/ = 'Blob|File';
  var v12/*CSSRule*/ = 'CSSRule|CSSCharsetRule|CSSFontFaceRule|CSSImportRule|CSSMediaRule|CSSPageRule|CSSStyleRule|CSSUnknownRule|WebKitCSSKeyframeRule|WebKitCSSKeyframesRule|WebKitCSSRegionRule';
  var v13/*CSSValueList*/ = 'CSSValueList|WebKitCSSTransformValue';
  var v14/*DOMTokenList*/ = 'DOMTokenList|DOMSettableTokenList';
  var v15/*Event*/ = [v4/*UIEvent*/,'Event|AudioProcessingEvent|BeforeLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|ErrorEvent|HashChangeEvent|IDBVersionChangeEvent|MediaStreamEvent|MessageEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|XMLHttpRequestProgressEvent|SpeechInputEvent|StorageEvent|TrackEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent'].join('|');
  var v16/*EventTarget*/ = [v8/*AbstractWorker*/,v9/*Node*/,'EventTarget|DOMApplicationCache|DOMWindow|EventSource|MessagePort|Notification|SVGElementInstance|WebSocket|XMLHttpRequest|XMLHttpRequestUpload'].join('|');
  ...
  var v20/*StyleSheet*/ = 'StyleSheet|CSSStyleSheet';
  ...
  var table = [
    ...
    , ['Uint8Array', v0/*Uint8Array*/]
    , ['ArrayBufferView', v10/*ArrayBufferView*/]
    , ['Blob', v11/*Blob*/]
    , ['CSSRule', v12/*CSSRule*/]
    , ['CSSValueList', v13/*CSSValueList*/]
    , ['CharacterData', v5/*CharacterData*/]
    , ['DOMTokenList', v14/*DOMTokenList*/]
